...
public interface ItemInfo {
	/**
	 * 
	 * @api {post} /api/item/itemInfoList  （后台）商品列表
	 ...
	 * @apiParam {String} [itemClassify] 商品分类
	 * @apiParam {int} [itemClassifyGrade] 商品分类等级
	 * @apiParam {String} itemBrandName 商品品牌
	 * @apiParam {int} [state] 上架或下架(1代表上架,0代表下架)
	 * 
	...
	/**
	 * 
	 * @api {post} /api/item/down  （后台）商品下架
	 * @apiName down
	 * @apiGroup itemInfo
	 * @apiVersion 0.1.0
	 * @apiDescription  商品下架
	...
	/**
	 * 
	 * @api {post} /api/item/delete  （后台）商品删除
	 * @apiName delete
	 * @apiGroup itemInfo
	 * @apiVersion 0.1.0
	 * @apiDescription  商品删除
	...
	/**
	 * 
	 * @api {post} /api/item/getItemId  （后台）获取商品编号
	 * @apiName getItemId
	 * @apiGroup itemInfo
	 * @apiVersion 0.1.0
	...
	/**
	 * 
	 * @api {post} /api/item/insert  （后台）商品新增
	 * @apiName insert
	 * @apiGroup itemInfo
	 * @apiVersion 0.1.0
	 * @apiDescription  商品新增
	 ...
	 * @apiParam {Object} itemDetail 商品详情
	 * @apiParam {String} itemDetail.itemPica  商品第一张图片
	 * @apiParam {String} itemDetail.itemPicb  商品第二张图片
	 ...
	 * @apiParam {String} itemDetail.itemUse 商品使用说明
	...
	/**
	 * 
	 * @api {post} /api/item/update  （后台）商品修改
	 * @apiName update
	 * @apiGroup itemInfo
	 * @apiVersion 0.1.0
	 * @apiDescription  商品修改
