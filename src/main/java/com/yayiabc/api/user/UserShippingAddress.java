...
public interface UserShippingAddress {
	/**
     * @api {post} http://192.168.1.103:8081/api/shoppingAdress/insert 新增收货地址
     * @apiName insert
     ...
     */
     /**
     * @api {post} http://192.168.1.103:8081/api/shoppingAdress/update 更改收货地址
     * @apiName update
     * @apiGroup shoppingAdress
     * @apiVersion 0.1.0
     ...
     */   
	 ...
	 /**
     * @api {post} http://192.168.1.103:8081/api/shoppingAdress/showshoppingA 更改收货地址
     * @apiName update
     * @apiGroup shoppingAdress
     * @apiVersion 0.1.0
     * @apiDescription 更改收货地址
     ...
     */ 
	 /**
     * @api {post} http://192.168.1.103:8081/api/shoppingAdress/showShippingAddress 显示收货地址
     ...
     */   
	 /**
     * @api {post} http://192.168.1.103:8081/api/shoppingAdress/deleteShippingAddress 删除收货地址
