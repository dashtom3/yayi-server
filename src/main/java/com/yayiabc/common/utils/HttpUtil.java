...
public class HttpUtil {
    ...
    public String sendPhoneCode(String code,String phoneNum){
        ...
        HttpUtil.sendPost(url,"sig="+SigParameter);
    ...
    public static boolean sendToSaleNotice(String phoneNum,String userPhone,String itemSumMoney,String actualMoneyHaocai,String actualMoneyGongju){
    ...
    //短信提示--牙医
    @SuppressWarnings("unchecked")
    public static boolean sendUserBind(String userPhone,String salePhone){
        HashMap<String, Object> result = null;
        ...
        //*则13800000000手机号收到的短信内容是：【云通讯】您使用的是云通讯短信模板，您的验证码是6532，请于5分钟内正确输入     *
        //*********************************************************************************************************************
        result = restAPI.sendTemplateSMS(userPhone,"204445" ,new String[]{userPhone,salePhone});
    ...
    //短信提示--客服代表
    @SuppressWarnings("unchecked")
    public static boolean sendSaleBind(String salePhone,String userPhone){
        HashMap<String, Object> result = null;
        ...
        //*则13800000000手机号收到的短信内容是：【云通讯】您使用的是云通讯短信模板，您的验证码是6532，请于5分钟内正确输入     *
        //*********************************************************************************************************************
        result = restAPI.sendTemplateSMS(salePhone,"204448" ,new String[]{salePhone,userPhone});
    ...
    //双11
    public static boolean sendPhoneVerifyCode1111(String phoneNum){
        HashMap<String, Object> result = null;
        ...
        //*则13800000000手机号收到的短信内容是：【云通讯】您使用的是云通讯短信模板，您的验证码是6532，请于5分钟内正确输入     *
        //*********************************************************************************************************************
        result = restAPI.sendTemplateSMS(phoneNum,"216863" ,null);
