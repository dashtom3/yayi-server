...
public class RedisClient {   
     ...
     static {    
          ...
          jedisPool = new JedisPool(config, "www.liqitian.top",  
            ...
            //redis未设置了密码：  
          // jedisPool = new JedisPool(config, "www.liqitian.top",6379);   
       }  
    ...
    public static void main(String[] args) {  
    	RedisClient jedisUtil= RedisClient.getInstance();    
    	RedisClient.Strings strings=jedisUtil.new Strings();  
        ...
        RedisClient.getInstance().returnJedis(jedis);     
    }  
