package com.yayiabc.http.mvc.controller.unionpay.demo.consume;
...
public class Form_6_2_FrontConsume{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		/***商户接入参数***/
		requestData.put("merId", "777290058150782");    	          			  //商户号码，请改成自己申请的正式商户号或者open上注册得来的777测试商户号
		...
		requestData.put("payTimeout", new SimpleDateFormat("yyyyMMddHHmmss").format(System.currentTimeMillis() + 30 * 60 * 1000));
