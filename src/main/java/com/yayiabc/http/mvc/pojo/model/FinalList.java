...
public class FinalList {
	...
	public String toString() {
		return "FinalList [itemId=" + itemId + ", itemSKU=" + itemSKU + ", itemSkuPrice=" + itemSkuPrice + ", tiChen="
				+ tiChen + ", itemQb=" + itemQb + ", stockNum=" + stockNum + ", canUse=" + canUse + ", itemValueId="
				+ itemValueId + ", itemPropertyName=" + itemPropertyName + ", itemPropertyInfo=" + itemPropertyInfo
				+ ", itemPropertyNameTwo=" + itemPropertyNameTwo + ", itemPropertyTwoValue=" + itemPropertyTwoValue
				+ ", itemPropertyNameThree=" + itemPropertyNameThree + ", itemPropertyThreeValue="
				+ itemPropertyThreeValue + ", itemPropertyFourName=" + itemPropertyFourName + ", itemPropertyFourValue="
				+ itemPropertyFourValue + ", itemPropertyFiveName=" + itemPropertyFiveName + ", itemPropertyFiveValue="
				+ itemPropertyFiveValue + ", itemPropertySixName=" + itemPropertySixName + ", itemPropertySixValue="
				+ itemPropertySixValue + ", itemName=" + itemName + ", itemType=" + itemType + ", itemBrandName="
				+ itemBrandName + ", picPath=" + picPath + "]";
	}
