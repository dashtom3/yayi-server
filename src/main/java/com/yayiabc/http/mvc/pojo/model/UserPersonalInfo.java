...
public class UserPersonalInfo {
    ...
    public Double getQbBalance() {
        return qbBalance;
    }

    public void setQbBalance(Double qbBalance) {
    ...
    public UserPersonalInfo(String userId, String phone, String trueName,
                            ...
                            String idCardOtherside, Double qbBalance) {
        super();
        this.userId = userId;
        this.phone = phone;
        this.trueName = trueName;
    ...
    public String toString() {
        return "UserPersonalInfo{" +
                ...
                ", idCardOtherside='" + idCardOtherside + '\'' +
                '}';
    }
}
