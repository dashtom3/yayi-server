...
public class SaleIncomeListServiceImpl implements SaleIncomeListService {
	...
	public DataWrapper<List<SaleIncomeVo>> query(String saleId,
			...
			Integer signLateSeven,Integer getState, String startDate, String endDate, Integer currentPage, Integer numberPerPage) {
		DataWrapper<List<SaleIncomeVo>> dataWrapper=new DataWrapper<List<SaleIncomeVo>>();
		Page page = new Page();
		page.setNumberPerPage(numberPerPage);
		page.setCurrentPage(currentPage);
		int totalNumber=saleIncomeListDao.getCount(saleId, saleName, salePhone, orderId, signLateSeven, getState, startDate, endDate);
		List<SaleIncomeVo> list=saleIncomeListDao.query(saleId, saleName, salePhone, orderId, signLateSeven, getState, startDate, endDate, page);
