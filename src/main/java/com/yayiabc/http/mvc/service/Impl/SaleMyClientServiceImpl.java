...
public class SaleMyClientServiceImpl implements SaleMyClientService {
	...
	@Override
	public DataWrapper<List<UserStatistics>> myClient(String value, final Integer state,
		...
		int totalNumber=saleMyClientDao.getCount(value, saleId, state);
		List<UserStatistics> list=saleMyClientDao.myClient(value,state,saleId, page);
